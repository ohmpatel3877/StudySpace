...
| File | Purpose |
|------|---------|
| `PROJECT.md` | Full spec: architecture, code layout, milestone table, interface contracts |
| `TEST_INFRA.md` | E2E test architecture, 4-tier structure, all test cases listed |
