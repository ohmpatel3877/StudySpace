...
- Name: bridge.spec.ts >> BRIDGE: Open in Default App (R10) >> T2_BRIDGE_1: Triggering default app for missing file displays error toast
- Location: tests\bridge.spec.ts:53:3
...
Call log:
  - waiting for locator('[data-testid="file-item-missing.md"]')
