...
- Name: office.spec.ts >> OFFICE: Office Document Viewer (R8) >> T1_OFFICE_5: Missing LibreOffice installation renders fallback warning
- Location: tests\office.spec.ts:36:3
...
Locator:  locator('[data-testid="viewer-fallback"]')
Expected: "LibreOffice required for office document conversion"
Received: "Markdown file loaded. Preview using the editor toolbar."
Timeout:  5000ms

Call log:
  - Expect "toHaveText" with timeout 5000ms
  - waiting for locator('[data-testid="viewer-fallback"]')
    14 × locator resolved to <div class="hidden" id="viewer-fallback" data-testid="viewer-fallback">Markdown file loaded. Preview using the editor to…</div>
       - unexpected value "Markdown file loaded. Preview using the editor toolbar."
