...
- Name: toggle.spec.ts >> TOGGLE: Modular Feature Toggles >> T2_TOGGLE_5: Corrupted Toggles State Recovery
- Location: tests\toggle.spec.ts:118:3
...
Locator:  locator('[data-testid="tab-d2l"]')
Expected: visible
Received: hidden
Timeout:  5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="tab-d2l"]')
    13 × locator resolved to <button id="btn-d2l" data-testid="tab-d2l" class="nav-btn hidden">D2L Calendar</button>
