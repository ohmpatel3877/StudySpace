...
- Name: bridge.spec.ts >> BRIDGE: Open in Default App (R10) >> T2_BRIDGE_4: Access-denied system files show warning when default app fails
- Location: tests\bridge.spec.ts:102:3
...
Call log:
  - waiting for locator('[data-testid="file-item-denied.md"]')
